    ...
    render: ->
        return (
            <div className="aboutme">
                ...
                <p>
                     And I have recently created a <b>React + Reflux workflow boilerplate</b> in the hope that the <b>React / Reflux community</b> can benefit from it.   What it will do is to make your development process more robust and you can extend on top of it.  Please see the repo for more detail and how to be benefit from it. 
                </p>
                <p>
